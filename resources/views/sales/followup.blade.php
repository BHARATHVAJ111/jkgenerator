...
@section('content')
    <div class="main">
        ...
        <div class="container-fluid">
            <div class="">
                <ul class="d-flex gap-5 bg-secondary pt-3 rounded-pill">
                    <p class="nav-item">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-flex gap-2">
                <a href="{{route('Followup.store.convert',['id'=>$values->id])}}" class="btn btn-primary">Converted</a>
                <a href="{{route('follow.store.denied',['id'=>$values->id])}}" class="btn btn-success">Denied</a>
                <a href="{{ route('email.view.followup', ['id' => $values->id]) }}" class="btn btn-primary">Mail</a>
