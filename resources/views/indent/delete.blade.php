<button type="button" class="btn delete-button" data-indent-id="{{ $indent->id }}" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal_{{ $indent->id }}">
    <i class="fa fa-trash" style="font-size:17px;color:red" aria-hidden="true"></i>
</button>

<div class="modal fade" id="deleteConfirmationModal_{{ $indent->id }}" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel" aria-hidden="true">
