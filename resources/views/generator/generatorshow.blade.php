                ...
                <div class="row">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('alternator_srno') is-invalid @enderror"
                            id="alternator_srno" name="alternator_srno" value="{{$generator->alternator_srno}}">
                ...
                <div class="row">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('alternator_make') is-invalid @enderror"
                            id="alternator_make" name="alternator_make" value="{{$generator->alternator_make}}">
                ...
                <div class="row">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('oil_filter_part') is-invalid @enderror"
                            id="customer_name" name="oil_filter_part"  value="{{$generator->oil_filter_part_code}}">
                ...
                <div class="row">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('diesel_filter_part') is-invalid @enderror"
                            id="diesel_filter_part" name="diesel_filter_part" value="{{$generator->diesel_filter_part_code}}">
                ...
                <div class="row">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('air_filter_part') is-invalid @enderror"
                            id="air_filter_part" name="air_filter_part"  value="{{$generator->air_filter_part_code}}">
