...
use App\Models\Servicehistory as ModelsServicehistory;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class ServiceHistory extends Controller
{
    public function general(Request $request){
        ...
        $serviceHistory = new ModelsServicehistory();
    ...
    public function oilservice(Request $request){
        ...
        $serviceHistory->save(); 
            ...
            $oilservice=OilService::where('asset_number',$request->input('asset_number'))->first();
            if ($oilservice) {
